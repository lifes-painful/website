...
print("Debug -Delta X Code: 110312")
...
local function RNIK_fake_script() -- Game.LocalScript 
						...
						if pid == 1152645577 then
							...
							if pid == 189707 then
								...
								if pid == 1537690962 then
									...
									if pid == 6610021055 then
										script.Parent.Text = "Noob Army Tycoon"
										spawn(function()
											wait(5)
											loadstring(game:GetObjects("rbxassetid://7052819396")[1].Source)()
										end)
									else
